createVICForcing <- function(maskRaster = 0, yr = "1980",
                             thisFilename = "Test"){
  ...
  metNcdfFile <- paste0(climaticsCodeDir,"/VIC/vic/drivers/image/forcings/forcings.",thisFilename,".nc")
  cat("writing ",metNcdfFile,fill=T)
