createVICVegRVic <- function(vicBdry = 0, vicGrid = 0, vicCellNmbr = 0,
                             resolutionKm = NULL){
  # k. westrick 2/5/2019
  ...
  processVeglib <- function(){
    Class <- glcRemapTable$glcVegCode
    remapIndices <- glcRemapTable$remap[match(Class,glcRemapTable$glcVegCode)]
